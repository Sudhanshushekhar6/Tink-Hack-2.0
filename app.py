...
app.config['MAIL_USERNAME'] = 'raushan0785@gmail.com'  # Ensure this is your correct email
app.config['MAIL_PASSWORD'] = 'guqectwznmpqvwln'  # Use an app-specific password, not your real password
app.config['MAIL_DEFAULT_SENDER'] = 'raushan0785@gmail.com'  # This must match MAIL_USERNAME
